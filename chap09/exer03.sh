...
# Write a program called mymv that does with the mv command what mycp does with
# the cp command. How many changes did you have to make to mycp to produce this
# new program?

# Note: this program modifies the file exer05.sh.  The only thing that is
# changed is that in the very last block of code, cp is changed to mv
